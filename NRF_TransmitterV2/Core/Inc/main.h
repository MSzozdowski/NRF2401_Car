...
/* Private defines -----------------------------------------------------------*/
#define LEFT_RIGHT_POT_Pin GPIO_PIN_0
#define LEFT_RIGHT_POT_GPIO_Port GPIOA
#define UP_DOWN_POT_Pin GPIO_PIN_1
#define UP_DOWN_POT_GPIO_Port GPIOA
...
#define BUZZER_STATE_Pin GPIO_PIN_8
#define BUZZER_STATE_GPIO_Port GPIOA
