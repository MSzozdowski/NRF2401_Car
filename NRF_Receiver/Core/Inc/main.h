...
#define BAT_VOLTAGE_Pin GPIO_PIN_2
#define BAT_VOLTAGE_GPIO_Port GPIOB
#define CONNECTION_STATUS_Pin GPIO_PIN_10
#define CONNECTION_STATUS_GPIO_Port GPIOA
#define A_PHASE_Pin GPIO_PIN_15
#define A_PHASE_GPIO_Port GPIOA
#define B_PHASE_Pin GPIO_PIN_3
#define B_PHASE_GPIO_Port GPIOB
...
#define DRV_MODE_Pin GPIO_PIN_8
#define DRV_MODE_GPIO_Port GPIOB
